...
function Header({ page = 'home' }) {
  const navItems = [
    { label: 'Developers', href: '/build/', match: 'build' },
    { label: 'Users', href: '/use/', match: 'use' },
    {
      label: page === 'build' ? 'Quickstart' : page === 'use' ? 'Wallet Setup' : 'Choose Your Path',
      href: '#get-started',
    },
    { label: 'Docs', href: 'https://docs.xian.org', target: '_blank', rel: 'noreferrer' },
    { label: 'dApps', href: '#showcase' },
    { label: 'Roadmap', href: '#roadmap' },
    { label: 'Explorer', href: 'https://explorer.xian.org', target: '_blank', rel: 'noreferrer' },
    { label: 'Bridge', href: 'https://bridge.xian.org', target: '_blank', rel: 'noreferrer' },
  ];
              ...
              {navItems.map((item) => (
                <li key={item.label}>
                  <a
                    ...
                    target={item.target}
                    rel={item.rel}
                    aria-current={item.match && item.match === page ? 'page' : undefined}
                  >
                    {item.label}
                  </a>
                </li>
